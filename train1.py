...
from model1 import SimpleLossCompute, LabelSmoothing, NoamOpt
...
log_dir = os.path.join('tensorboard1', 'ori_train')
train_writer = SummaryWriter(log_dir=log_dir)

# 将 test accuracy 保存到 "tensorboard1/test" 文件夹
log_dir = os.path.join('tensorboard1', 'ori_test')
...
# state_dict = torch.load('/root/home/zkl/Transformer2/save/150_de_en_model.pt')
