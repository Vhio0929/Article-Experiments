...
class PreNorm(nn.Module):
    def __init__(self, dim, fn):
        ...
        self.fn = fn
    def forward(self, single, x, **kwargs):
        return self.fn(single, self.norm(x), **kwargs)
...
class Attention1(nn.Module):
    ...
    def forward(self, single, x, mask=None):
        #x, single = y
        n, q_len = x.shape[0:2]
        n, k_len = x.shape[0:2]
